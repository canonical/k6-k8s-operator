...
"""Integration tests for k6-k8s with Loki log shipping and Prometheus remote write."""
...
def test_run_single_unit(juju: jubilant.Juju):
    """Configure and run a load test, then verify both Loki logs and Prometheus metrics."""
